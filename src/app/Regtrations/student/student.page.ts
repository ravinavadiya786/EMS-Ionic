...
export class StudentPage implements OnInit {
  ...
  ngOnInit() {
    ...
    this.http
      .get(
        "https://cooing-famous-iguanacolossus.glitch.me/Admin/Standard",
        {},
        {
      ...
      .then(data => {
        this.Standard = JSON.parse(data.data).filter(ele => { if (ele.Is_Active) return ele })
        const toSelect = this.Standard.find(c => c._id);
        this.form.get('Standard_id').setValue(toSelect._id);
      })
      .catch(e => console.log(e));
  }
